...
BitDollar is a member of the Blaque Baux family. The [core repo](https://github.com/blaquebaux/base)
...
```bash
git clone --recursive https://github.com/blaquebaux/bitdollar.git
